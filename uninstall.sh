...
echo ""
echo "Note: If the installer modified your opencode.json, a backup was saved as"
echo "  ~/.config/opencode/opencode.json.bak"
echo "  Restore it with: cp ~/.config/opencode/opencode.json.bak ~/.config/opencode/opencode.json"
echo ""
